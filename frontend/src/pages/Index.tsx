        ...
        <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr]">
            <div>
              ...
              <p className="mt-5 max-w-md text-sm leading-6 text-muted-foreground">CornerStores keeps the most useful signals in the open: what a shop is, where it is, whether it is open, and how far it is from you.</p>
